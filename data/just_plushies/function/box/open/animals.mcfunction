advancement revoke @s only just_plushies:open/animals

scoreboard players add @s jp_total 1
scoreboard players add @s jp_themed 1
scoreboard players add @s jp_animals 1
function just_plushies:box/check_milestones

loot spawn ~ ~ ~ loot just_plushies:plushie/pool/animals/everything
