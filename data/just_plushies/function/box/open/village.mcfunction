advancement revoke @s only just_plushies:open/village

scoreboard players add @s jp_total 1
scoreboard players add @s jp_themed 1
scoreboard players add @s jp_village 1
function just_plushies:box/check_milestones

loot spawn ~ ~ ~ loot just_plushies:plushie/pool/village/everything
