advancement revoke @s only just_plushies:open/sea_creatures

scoreboard players add @s jp_total 1
scoreboard players add @s jp_themed 1
scoreboard players add @s jp_sea_creatures 1
function just_plushies:box/check_milestones

loot spawn ~ ~ ~ loot just_plushies:plushie/pool/sea_creatures/everything
